...
import { Actividades, NameCoros } from '../../util/Strings'
...
function CorosTurnos() {
    ...
    const [title, setTitle] = useState<string>("Agregar Nuevo Turno")
      ...
      return (
        ...
        <Modal show={showModal} setShow={setShowModal} onSubmit={handelSubmit} title={title} >
         {/*    <TextInput value={nombre} onChange={handleNombre} label='Actividad' type='text' required/> */}
            ...
            <InputSelect item={NameCoros} onClick={selectEncargado} onChange={handleEncargado} value={encargado} label='Seleccionar o ingresar encargado' required />  
